...
case ${service,,} in
  master)
    ...
    # integration/docker/bin/alluxio-job-master.sh &    # removed by bbklab, fuck this, offical image doesn't have this
  ...
  worker)
    ...
    # integration/docker/bin/alluxio-job-worker.sh &    # removed by bbklab, fuck this, offical image doesn't have this
